...
export const metadata: Metadata = {
  ...
  description: 'Artigos, ensaios e notícias do Grupo de Estudos em Filosofia ΣΤΑΣΙΣ da UFRRJ.',
};

const GreekPatternLine = () => (
  <div className="my-8 h-2 w-full max-w-xs mx-auto overflow-hidden" aria-hidden="true" data-ai-hint="greek pattern divider">
    <svg width="100%" height="100%" viewBox="0 0 100 2" preserveAspectRatio="none">
      <line x1="0" y1="1" x2="100" y2="1" stroke="hsl(var(--accent))" strokeWidth="2" strokeDasharray="5 3" />
    </svg>
  </div>
);
    ...
    <div className="space-y-12">
      <section className="text-center py-8 bg-card shadow-lg rounded-lg">
        ...
        <p className="text-lg text-foreground/80 max-w-2xl mx-auto px-4">
          Explore nossos artigos, ensaios e notícias sobre filosofia e eventos do grupo.
        </p>
      </section>
