...
export const mockPosts: Post[] = [
  {
    ...
    excerpt:
      "Uma análise profunda sobre o conceito de stásis (conflito, imobilidade) nos fragmentos de Heráclito e sua relevância para a ontologia pré-socrática.",
  ...
  },
  {
    ...
    excerpt:
      'Convidamos a todos para a palestra "A Eudaimonia na Ética a Nicômaco de Aristóteles", que ocorrerá no próximo dia 10 de Agosto. Aberto ao público.',
  ...
  },
  {
    ...
    excerpt:
      "Uma breve meditação sobre a concepção agostiniana do tempo, como apresentada no Livro XI das Confissões. O que é, afinal, o tempo?",
  ...
  },
  {
    ...
    excerpt:
      "Explorando uma das passagens mais cruciais da Fenomenologia do Espírito de Hegel: a luta por reconhecimento e a formação da autoconsciência.",
