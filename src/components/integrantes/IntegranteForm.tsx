...
export default function IntegranteForm({ initialData, onSubmit, isSubmitting = false }: IntegranteFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="areaPesquisa" className="block text-sm font-medium text-gray-700">Área de Pesquisa (Opcional)</label>
        <input
          type="text"
          id="areaPesquisa"
          name="areaPesquisa"
      ...
      <div>
        <label htmlFor="instituicao" className="block text-sm font-medium text-gray-700">Instituição <span className="text-red-500">*</span></label>
        <input
          type="text"
          id="instituicao"
          name="instituicao"
      ...
      <div>
        <label htmlFor="curriculoLattes" className="block text-sm font-medium text-gray-700">Currículo Lattes URL (Opcional)</label>
        <input
       ...
       <div>
        <label htmlFor="imageUrl" className="block text-sm font-medium text-gray-700">Imagem URL (Opcional)</label>
        ...
        />
          {formData.imageUrl && (
              <div className="mt-2">
                  <img src={formData.imageUrl} alt="Preview" className="max-h-32 object-cover rounded" />
              </div>
          )}
      </div>
      <div>
        ...
        >
          {isSubmitting ? 'Salvando...' : initialData ? 'Atualizar Integrante' : 'Adicionar Integrante'}
        </button>
