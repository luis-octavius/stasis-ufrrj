...
export default function PostDetailClient({
  ...
  useEffect(() => {
    if (initialPostData === undefined && slug) {
      // Only fetch if initialData was explicitly NOT provided (undefined)
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 text-sm mb-4">
        Por {post.authorId} em {formattedDate}{" "}
        {/* Use authorId, you might want to fetch author name later */}
      </p>
      <div
