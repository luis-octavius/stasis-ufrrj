  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-3xl font-semibold uppercase-ancient mb-6 text-accent">
          Contato
        </h2>
        <p className="mb-2 text-lg">Grupo de Estudos em Filosofia Stásis</p>
        <p className="mb-4 text-md text-primary-foreground/80">
          Universidade Federal Rural do Rio de Janeiro (UFRRJ)
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-8">
          <a
            href="mailto:contato.stasis.ufrrj@gmail.com"
            className="hover:text-tertiary transition-colors flex items-center text-primary-foreground/90"
          >
          ...
          >
            ...
            <MessageSquare className="mr-2" size={20} /> Redes Sociais (em
            breve)
          </a>
          <a
            href="https://portal.ufrrj.br/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-accent transition-colors flex items-center text-primary-foreground/90"
          >
